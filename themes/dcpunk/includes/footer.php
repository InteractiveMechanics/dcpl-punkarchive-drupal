	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<ul class="footer-nav">
					<li><a href="about.html">About the Archive</a></li>
					<li><a href="contribute.html">Contribute to the Archive</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="address-block">
				<p><a href="http://wwww.dclibrary.org"><img src="images/dcpl_logo.png" alt="DC Public Library logo" id="logo"></a></p>
